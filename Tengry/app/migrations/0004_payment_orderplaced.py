    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('Заказ принят', 'Заказ принят'), ('Заказ собирается', 'Заказ собирается'), ('В пути', 'В пути'), ('Доставлено', 'Доставлено'), ('Заказ отклонен', 'Заказ отклонен'), ('В ожидании', 'В ожидании')], default='Pending', max_length=50)),
